...
public class TotalSalary {
    public static void main(String[] args) {
        ...
        double hra=(20*basic)/100.0;
        double da=(50*basic)/100.0;
        double pf=(11*basic)/100.0;
        if (grade=='A'){
            double salary=basic+hra+da+1700-pf;
            System.out.println(Math.round(salary));
        } else if (grade=='B') {
            double salary=basic+hra+da+1500-pf;
            System.out.println(Math.round(salary));

        }
        else {
            double salary=basic+hra+da+1300-pf;
            System.out.println(Math.round(salary));
        }
